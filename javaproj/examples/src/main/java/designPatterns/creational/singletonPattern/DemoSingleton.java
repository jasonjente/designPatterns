...
public class DemoSingleton {
    ...
    public static void main(String[] args) throws IOException {
        ...
        LateJDBCSingleton jdbc= LateJDBCSingleton.getInstance();
        ...
        do{
            ...
            switch(choice) {
                ...
                case 1:{
                    ...
                    System.out.print("Enter the email you want to insert data into the database: ");
                    String email = br.readLine();

                    try {
                        int i= jdbc.insert(username, password, email, Timestamp.from(Instant.now()));
                        if (i>0) {
                ...
                case 4:{
                    ...
                    try {
                        int i= jdbc.updateUserPassword(username, password);
                        if (i>0) {
